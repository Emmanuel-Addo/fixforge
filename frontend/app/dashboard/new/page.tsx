...
export default function NewProjectPage() {
  ...
  const handleGrantPermission = async () => {
    ...
    try {
      ...
      setTimeout(() => {
        setConnecting(false);
        setOauthError("GitHub OAuth did not redirect. Please check your Supabase dashboard configuration.");
      }, 4000);
    } catch (err: any) {
      ...
      setOauthError(
        err?.message ||
          "GitHub OAuth error. Make sure GitHub auth is enabled in your Supabase project."
      );
    }
  };
